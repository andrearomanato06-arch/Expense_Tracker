...
<%
    List<Expense> expenses = request.getAttribute("expenses")== null ? new ArrayList<>() : (List<Expense>) request.getAttribute("expenses");
    int currentPage =request.getAttribute("page") == null ? 1 : (Integer) request.getAttribute("page");
    int pageToShow = request.getAttribute("pageToShow") == null ? 1 :   (Integer) request.getAttribute("pageToShow");
